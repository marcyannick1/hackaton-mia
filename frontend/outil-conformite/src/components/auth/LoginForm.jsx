                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input type="email" value={email} onChange={e => {
                            ...
                            setError("");
                        }} placeholder="prenom.nom@docflow.fr" required
                               className="w-full h-10 px-3.5 text-sm bg-slate-50 border border-slate-200 rounded-lg text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all"/>
                    </div>
                    <div>
                    ...
                    {error && (
                        <div
                            className="flex items-center gap-2 text-xs text-red-600 bg-red-50 border border-red-200 rounded-lg px-3.5 py-2.5">
                    ...
                    <button type="submit" disabled={authLoading}
                            className="w-full h-10 bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-400 text-white text-sm font-medium rounded-lg transition-all active:scale-[0.98] flex items-center justify-center gap-2">
                        {authLoading ?
                ...
                <div className="mt-6 pt-5 border-t border-slate-100">
                    <div className="mt-4 text-center">
                        <p className="text-xs text-slate-400">Pas encore de compte ?{" "}
                            <Link to="/register"
                                  className="text-emerald-600 hover:text-emerald-800 font-medium transition-colors">S
                                inscrire</Link>
                        </p>
                    </div>
                </div>
