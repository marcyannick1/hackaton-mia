...
const LABELS = {
  valide: "Valide", conforme: "Conforme", ok: "OK", attention: "A verifier",
  alerte: "Alerte", warn: "Attention", attente: "En attente",
  expire: "Expiree", error: "Erreur", approuve: "Approuve", rejete: "Rejete", payee: "Payee",
};
export default function Badge({ statut }) {
  ...
  return <span className={`inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-medium ${classes}`}>{label}</span>;
}
